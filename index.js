...
/**
 * CheckAudioInterfaceHandler will determine if the device from which 
 * the request originated is capable of playing an audio stream.
 * 
 * @type {Object}
 * 
 * @method canHandle is used to determine if this Request handle can be used to respond to a specific request.
...
/**
 * StartPlaybackHandler: handler will be fired for any type of play Play intent received
 * Possible intents are PlayAudio, PlaybackControler play commands or an Amazon Resume intent.  
 * 
 * @type {Object}
 * 
 * @method canHandle is used to determine if this Request handle can be used to respond to a specific request.
...
/**
 * NextPlaybackHandler: handler will be fired for any type of Next intent received
 * Possible intents, PlaybackControler next commands or an Amazon Next intent.  
 * 
 * @type {Object}
 * 
 * @method canHandle is used to determine if this Request handle can be used to respond to a specific request.
...
/**
 * PreviousPlaybackHandler: handler will be fired for any type of Previous intent received
 * Possible intents, PlaybackControler previous commands or an Amazon Previous intent.  
 * 
 * @type {Object}
 * 
 * @method canHandle is used to determine if this Request handle can be used to respond to a specific request.
...
/**
 * PausePlaybackHandler: handler will be fired for any type of Previous intent received
 * Possible intents, Amazon Stop Intent, Amazona Cancel Intent, Amazon Pause Intent, or 
 * PlaybackController Pause commands.  Must also be an IntentRequest.  
 * 
 * @type {Object}
 * 
 * @method canHandle is used to determine if this Request handle can be used to respond to a specific request.
...
/**
 * LoopOnHandler: handler will be fired for Amazon Loop intent requests.
 * 
 * @type {Object}
 * 
 * @method canHandle is used to determine if this Request handle can be used to respond to a specific request.
...
/**
 * LoopOffHandler: handler will be fired for Amazon Loop Off intent requests.
 * 
 * @type {Object}
 * 
 * @method canHandle is used to determine if this Request handle can be used to respond to a specific request.
...
/**
 * ShuffleOnHandler: handler will be fired for Amazon Shuffle on intent requests.
 * Currently we simply return a message letting the user know that shuffle is not
...
/**
 * ShuffleOffHandler: handler will be fired for Amazon Shuffle Off intent requests.
 * Currently we simply return a message letting the user know that shuffle is not
 * supported by this skill.
 * 
 * @type {Object}
...
/**
 * StartOverHandler: handler will be fired for Amazon StartOver intent requests.
 * This handler resets the offset for the current audio stream to 0 and then 
